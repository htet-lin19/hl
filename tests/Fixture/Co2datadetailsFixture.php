...
class Co2datadetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'co2_device_id' => ['type' => 'foreign', 'columns' => ['co2_device_id'], 'references' => ['room_info', 'device_id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 'f2c49165-43c4-452b-b523-03d028d29af9',
                'co2_device_id' => 'Lorem ipsum dolor sit amet',
                'temperature' => 1,
                'humidity' => 1,
                'co2' => 1,
                'noise' => 1,
                'time_measured' => '2021-06-18 09:51:17',
            ],
        ];
        parent::init();
    }
